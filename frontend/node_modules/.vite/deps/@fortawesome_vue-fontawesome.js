...
var svgCorePackageJson = require_package();
...
var FontAwesomeLayers = defineComponent({
  ...
  setup: function setup2(props, _ref2) {
    ...
    var className = computed(function() {
      return ["".concat(familyPrefix, "-layers")].concat(_toConsumableArray2(versionCheckLt(SVG_CORE_VERSION, ICON_PACKS_STARTING_VERSION) && props.fixedWidth ? ["".concat(familyPrefix, "-fw")] : []));
    });
    return function() {
      return h("div", {
