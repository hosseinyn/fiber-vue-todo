...
const handleLogin = () => {
    ...
    .catch(function (error) {
        console.log(error);
        console.log("username : " , usernameValue.value , "password: " , passwordValue.value)
    });
}
                        ...
                        <form class="space-y-4 md:space-y-6" action="#" @submit.prevent="handleLogin">
                            <div>
                                ...
                                <input type="text" name="username" id="username"
                                    ...
                                    placeholder="Enter your username..." required v-model="usernameValue">
                            </div>
                            <div>
                                <label for="password"
                                ...
                                <input type="password" name="password" id="password" placeholder="Enter your password..."
                                    class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required v-model="passwordValue">
                            </div>
                            <button type="submit"
